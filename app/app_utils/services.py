...
from google.adk.cli.utils.service_factory import create_session_service_from_options, create_memory_service_from_options
...
def get_memory_service():
    """Process-wide memory service using Vertex AI Memory Bank when available."""
    ...
    if agent_engine_id := os.environ.get("GOOGLE_CLOUD_AGENT_ENGINE_ID"):
        ...
        return VertexAiMemoryBankService(
            project=os.environ.get("GOOGLE_CLOUD_PROJECT", "qwiklabs-gcp-01-d2704f34ae2b"),
            location=os.environ.get("GOOGLE_CLOUD_AGENT_ENGINE_LOCATION")
            or os.environ.get("GOOGLE_CLOUD_LOCATION", "us-east1"),
            agent_engine_id=agent_engine_id,
        )
    if memory_bank_id := os.environ.get("MEMORY_BANK_ID"):
        from google.adk.memory import VertexAiMemoryBankService
